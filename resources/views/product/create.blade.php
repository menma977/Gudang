            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('name') is-invalid @enderror" id="name"
                           name="name" placeholder="Nama Product" value="{{ old('name') }}">
                    @error('name')
                    <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('price_buy') is-invalid @enderror" id="price_buy"
                           name="price_buy" placeholder="Harga Beli" value="{{ old('price_buy') }}">
                    @error('price_buy')
                    <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group mb-3">
                        <input type="text" class="form-control @error('margin') is-invalid @enderror" id="margin"
                               name="margin" placeholder="Margin" value="{{ old('margin') }}">
                ...
                <div class="card card-primary">
                    <div class="card-header d-flex p-0">
                        ...
                        <ul class="nav nav-pills ml-auto p-2">
                            ...
                            <li class="nav-item">
                                <a class="nav-link @error('quantity') active @enderror"
                                   href="#tab_2" data-toggle="tab">
                                    Discount Geratis barang
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link @error('quantity1') active @enderror"
                    ...
                    <div class="card-body">
                        <div class="tab-content">
                            ...
                            <!-- /.tab-pane -->
                            <div class="tab-pane @error('quantity') active @enderror" id="tab_2">
                            ...
                            <!-- /.tab-pane -->
                            <div class="tab-pane @error('quantity1') active @enderror" id="tab_3">
                                <small>Jangan di isi semuanya ketika di isi geratis barang dan discount harga akan
                                    otomatis terplih geratis barang</small>
                                <div class="row">
                                    <div class="col-md-6">
